            ...
            <div className='flex justify-between m-5'>
                        ...
                        <div className="relative flex items-center mt-5">
                            ...
                            <div className="absolute left-5">
                                <svg width="28" height="29" viewBox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M8.75 11V8.08337C8.75 5.18388 11.1005 2.83337 14 2.83337C16.8995 2.83337 19.25 5.18388 19.25 8.08337V11" stroke="#616161" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M18.6665 18.5717V18.5833" stroke="#616161" strokeWidth="2.33333" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M14 18.5717V18.5833" stroke="#616161" strokeWidth="2.33333" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M9.3335 18.5717V18.5833" stroke="#616161" strokeWidth="2.33333" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            ...
                            <div className="absolute right-5 cursor-pointer" onClick={togglePasswordVisibility}>
                                ...
                                {passwordVisible ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#616161" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-eye">
                                    ...
                                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g opacity="0.8">
                                            <path d="M19.439 15.939C20.3636 15.0212 21.0775 14.1091 21.544 13.455C21.848 13.0287 22 12.8155 22 12.5C22 12.1845 21.848 11.9713 21.544 11.545C20.1779 9.62944 16.6892 5.5 12 5.5C11.0922 5.5 10.2294 5.65476 9.41827 5.91827M6.74742 7.24742C4.73118 8.6072 3.24215 10.4427 2.45604 11.545C2.15201 11.9713 2 12.1845 2 12.5C2 12.8155 2.15201 13.0287 2.45604 13.455C3.8221 15.3706 7.31078 19.5 12 19.5C13.9908 19.5 15.7651 18.7557 17.2526 17.7526" stroke="#9E9E9E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M9.85786 10.5C9.32783 11.03 9 11.7623 9 12.5711C9 14.1887 10.3113 15.5 11.9289 15.5C12.7377 15.5 13.47 15.1722 14 14.6421" stroke="#616161" strokeWidth="1.5" strokeLinecap="round" />
                                            <path d="M3 3.5L21 21.5" stroke="#616161" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </g>
                                    </svg>
                                )}
                ...
                <div className="flex flex-col items-center justify-center h-screen">
                    <button
                        ...
                        onClick={onClose}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-x"><path d="M18 6 6 18" /><path d="m6 6 12 12" /></svg>
                    </button>
