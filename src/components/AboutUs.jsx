                        ...
                        <div className='grid-cols-2 grid mt-8 gap-8'>
                            ...
                            <div className='flex items-center gap-3'>
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_1_1032)">
                                        <path d="M20.0001 7.40601L22.3078 12.0817L27.4677 12.8315L23.7339 16.471L24.6154 21.61L20.0001 19.1837L15.385 21.61L16.2664 16.471L12.5327 12.8315L17.6926 12.0817L20.0001 7.40601Z" stroke="#0A65CC" strokeWidth="2" strokeMiterlimit="10" />
                                        <path d="M20.0001 29.2509C27.7284 29.2509 33.9934 22.9859 33.9934 15.2577C33.9934 7.52941 27.7284 1.2644 20.0001 1.2644C12.2718 1.2644 6.00684 7.52941 6.00684 15.2577C6.00684 22.9859 12.2718 29.2509 20.0001 29.2509Z" stroke="#0A65CC" strokeWidth="2" strokeMiterlimit="10" />
                                        <path d="M16.0603 28.6878L10.0364 36.979L8.94683 30.6268L2.56885 31.5536L8.55633 23.3125" stroke="#0A65CC" strokeWidth="2" strokeMiterlimit="10" />
                                        <path d="M23.9399 28.6878L29.9639 36.979L31.0534 30.6268L37.4314 31.5536L31.4438 23.3125" stroke="#0A65CC" strokeWidth="2" strokeMiterlimit="10" />
                                    </g>
                                    <defs>
                            ...
                            <div className='flex items-center gap-3'>
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_1_1066)">
                                        <path d="M24.969 30.9312L20.0271 33.7551L15.0853 30.9312C10.3117 28.2034 7.36572 23.1269 7.36572 17.6289V4.21879L20.0272 1.19678L32.6887 4.21879V17.629C32.6886 23.1269 29.7426 28.2034 24.969 30.9312Z" stroke="#0A65CC" strokeWidth="2" strokeMiterlimit="10" />
                                        <path d="M15.1292 30.975L9.68707 37.9298L7.04176 33.3919L2.03906 31.7911L8.67981 23.719" stroke="#0A65CC" strokeWidth="2" strokeMiterlimit="10" />
                                        <path d="M24.8994 31.0011L30.3153 37.9297L32.9605 33.3919L37.9633 31.7911L31.4034 23.7998" stroke="#0A65CC" strokeWidth="2" strokeMiterlimit="10" />
                                        <path d="M20.0274 9.6853L22.4382 12.9861L26.3224 14.2589L23.9282 17.5717L23.9179 21.6591L20.0274 20.4058L16.1368 21.6591L16.1266 17.5717L13.7324 14.2589L17.6166 12.9861L20.0274 9.6853Z" stroke="#0A65CC" strokeWidth="2" strokeMiterlimit="10" />
                                    </g>
                                    <defs>
                ...
                <div className='sm:flex justify-between  items-start mt-16'>
                    <div className='sm:w-1/2 '>
                        ...
                        <div className='mt-14 grid sm:grid-cols-2 grid-cols-1 gap-14'>
                            ...
                            <div className='items-start'>
                                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M4.66683 4.66675H23.3335C24.6168 4.66675 25.6668 5.71675 25.6668 7.00008V21.0001C25.6668 22.2834 24.6168 23.3334 23.3335 23.3334H4.66683C3.3835 23.3334 2.3335 22.2834 2.3335 21.0001V7.00008C2.3335 5.71675 3.3835 4.66675 4.66683 4.66675Z" stroke="#0A65CC" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M25.6668 7L14.0002 15.1667L2.3335 7" stroke="#0A65CC" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
